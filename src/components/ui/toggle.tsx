...
const toggleVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-white transition-colors hover:bg-primary-500 hover:text-white focus-visible:outline-none  disabled:pointer-events-none disabled:opacity-50 data-[state=on]:bg-neutral-100 data-[state=on]:text-neutral-900 dark:ring-offset-neutral-950 hover:bg-primary-500  dark:data-[state=on]:bg-primary-500 dark:data-[state=on]:text-white dark:data-[state=on]:border-none  hover:border-primary-500",
  {
    variants: {
      variant: {
