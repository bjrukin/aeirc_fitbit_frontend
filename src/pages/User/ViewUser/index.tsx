  ...
  return (
    <DashboardLayout>
      ...
      <div className="mt-7 flex justify-between space-x-4 ">
        <div className="w-2/3">{renderUserCard("respiratory_rate_value")}</div>
        ...
        <div className="flex-1">
          <div className=" p-6  border-[1px] border-tertiary-750 bg-white  rounded-lg w-full">
            ...
            <div className="pt-[35px]">
              <p className="font-semibold text-xl text-black">8 Hours 12 min</p>
              <p className="font-bold text-lg text-text-green">Normal Sleep</p>
          ...
          <div className="mt-4 p-6  border-[1px] border-tertiary-750 bg-white  rounded-lg w-full">
            ...
            <div className="pt-[35px]">
              <p className="font-semibold text-xl text-black">90 KPa</p>
              <p className="font-bold text-lg text-text-green">Normal</p>
              <p className="font-semibold text-lg text-tertiary-950">
